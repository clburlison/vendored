...
# cp build/lib.macosx-10.12-intel-2.7/{_tlsssl.so, tlsssl.py} /Library/Python/2.7/site-packages/tlsssl
# mkdir -p /usr/local/lib/tlsssl
# cp build/lib.macosx-10.12-intel-2.7/{libtlscrypto.dylib, libtlsssl.dylib} /usr/local/lib/tlsssl
